...
namespace boost { namespace simd { namespace cmplx
  ...
  /*!
    ...
    @defgroup complex-acosh acosh (function object, complex version)

    This function object, complex version computes complex hyperbolic cosine of a complex value z.
