...
#define BOOST_SIMD_FUNCTION_REM_PIO2_MEDIUM_HPP_INCLUDED
  ...
  /*!
    ...
    The accurate algorithm  [rem_pio2](@ref real-rem_pio2) is over costly and implies the knowledge
    ...
    @see ( %real ) [rem_pio2](@ref real-rem_pio2), [rem_pio2_straight](@ref real-rem_pio2_straight), [rem_2pi](@ref real-rem_2pi), [rem_pio2_cephes](@ref real-rem_pio2_cephes)
