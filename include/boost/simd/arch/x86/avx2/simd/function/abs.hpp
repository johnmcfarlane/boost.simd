...
{
  BOOST_FORCEINLINE
  pack<std::int8_t,32,avx_> abs_( BOOST_SIMD_SUPPORTS(avx2_)
  ...
  BOOST_FORCEINLINE
  pack<std::int16_t,16,avx_> abs_( BOOST_SIMD_SUPPORTS(avx2_)
  ...
  BOOST_FORCEINLINE
  pack<std::int32_t,8,avx_> abs_( BOOST_SIMD_SUPPORTS(avx2_)
