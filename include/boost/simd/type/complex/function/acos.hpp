...
namespace boost { namespace simd
{
  ...
  /*!
    ...
    @defgroup complex-acos acos (function object, complex version)

    This function object, complex version computes complex arc cosine of a complex value z. Branch cut exists outside
