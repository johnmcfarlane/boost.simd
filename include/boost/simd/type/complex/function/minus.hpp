...
namespace boost { namespace simd { namespace cmplx
{
  ...
  /*!
    ...
    @defgroup complex-minus minus (function object, complex version)

    This function object, complex version implements the binary difference operator for complex arithmetic
