...
{
  BOOST_FORCEINLINE pack<double,4,avx_> is_equal_( BOOST_SIMD_SUPPORTS(avx_)
  ...
  BOOST_FORCEINLINE pack<float,8,avx_> is_equal_ ( BOOST_SIMD_SUPPORTS(avx_)
  ...
  BOOST_FORCEINLINE pack<double,2,sse_> is_equal_( BOOST_SIMD_SUPPORTS(sse_)
  ...
  BOOST_FORCEINLINE pack<float,4,sse_> is_equal_ ( BOOST_SIMD_SUPPORTS(sse_)
