...
#define BOOST_SIMD_FUNCTION_SECPI_HPP_INCLUDED
  ...
  /*!
    ...
    @defgroup real-secpi secpi (function object)

    This function object returns the secant of the angle in pi multiples:
    \f$1/\cos(\pi x)\f$.

    @headerref{<boost/simd/function/secpi.hpp>}
    ...
    @see ( %real ) [secd](@ref real-secd), [sec](@ref real-sec), [cospi](@ref real-cospi), [cos](@ref real-cos)
