...
namespace boost { namespace simd { namespace ext
{
                         ...
                         )
  {
    ...
    {
      return A0( extract<0>(a0), extract<0>(a1) );
    }

    BOOST_FORCEINLINE A0 do_(const A0& a0, const A0& a1,nsm::size_t<4> const) const BOOST_NOEXCEPT
    {
      return A0( extract<0>(a0), extract<2>(a0), extract<0>(a1), extract<2>(a1) );
    }
                         ...
                         )
  {
    BOOST_FORCEINLINE A0 operator()(const A0& a0, const A0& a1 ) const BOOST_NOEXCEPT
    {
      ...
      return bitwise_cast<A0> ( deinterleave_first( bitwise_cast<f_t>(a0)
                                                  , bitwise_cast<f_t>(a1)
                                                  )
                              );
    }
