...
namespace boost { namespace simd { namespace detail
{
  ...
  is_not_less_ ( BOOST_SIMD_SUPPORTS(avx_)
                  , pack<double,4,avx_> const& a0
                  , pack<double,4,avx_> const& a1
                  ) BOOST_NOEXCEPT
  {
    return _mm256_cmp_pd(a0,a1, _CMP_NLT_OQ);
  }
  ...
  {
    return _mm256_cmp_ps(a0,a1, _CMP_NLT_OQ);
  }
  ...
  {
    return _mm_cmp_pd(a0,a1, _CMP_NLT_OQ);
  }
  ...
  {
    return _mm_cmp_ps(a0,a1, _CMP_NLT_OQ);
  }
