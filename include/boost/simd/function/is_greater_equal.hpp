...
#define BOOST_SIMD_FUNCTION_IS_GREATER_EQUAL_HPP_INCLUDED
  ...
  /*!
    ...
    @defgroup real-is_greater_equal is_greater_equal (function object)
    ...
    @headerref{<boost/simd/function/is_greater_equal.hpp>}
    ...
    @see ( %real ) [is_greater](@ref real-is_greater), [is_gtz](@ref real-is_gtz)
