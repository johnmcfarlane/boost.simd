...
#define BOOST_SIMD_FUNCTION_LOGICAL_OR_HPP_INCLUDED
  ...
  /*!
    ...
    @see ( %real ) [logical_not](@ref real-logical_not), [logical_xor](@ref real-logical_xor), [logical_andnot](@ref real-logical_andnot), [logical_notand](@ref real-logical_notand), [logical_ornot](@ref real-logical_ornot), [logical_and](@ref real-logical_and), [logical_notor](@ref real-logical_notor)
