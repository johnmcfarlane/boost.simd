...
namespace boost { namespace simd { namespace detail
{
  ...
  ifnot_minus_(BOOST_SIMD_SUPPORTS(simd_)
           , pack<C,N> const & a0
           , pack<T,N> const & a1
  ...
  {
    return map_to(ifnot_minus, a0, a1, a2);
  }
  ...
  {
    using p_t = pack<V,N>;
    return ifnot_minus(a0, p_t(a1), a2);
  }
  ...
  {
    using p_t = pack<U,N>;
    return ifnot_minus(a0, a1, p_t(a2));
  }
  ...
  {
    using p_t = pack<U,N>;
    return ifnot_minus(a0, p_t(a1), p_t(a2));
  }
