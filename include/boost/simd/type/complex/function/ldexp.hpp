...
#define BOOST_SIMD_TYPE_COMPLEX_FUNCTION_LDEXP_HPP_INCLUDED
  ...
  /*!
    ...
    @defgroup complex-ldexp ldexp (function object, complex version)

    This function object, complex version returns ldexp aplied to both real and imaginary parts of the first input.
