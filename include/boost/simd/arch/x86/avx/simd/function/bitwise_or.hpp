...
{
  BOOST_FORCEINLINE pack<float,8,avx_> bitwise_or_ ( BOOST_SIMD_SUPPORTS(avx_)
  ...
  BOOST_FORCEINLINE pack<double,4,avx_> bitwise_or_( BOOST_SIMD_SUPPORTS(avx_)
  ...
  template< typename T, std::size_t N
          ...
          >
  BOOST_FORCEINLINE pack<T, N, avx_> bitwise_or_ ( BOOST_SIMD_SUPPORTS(avx_)
