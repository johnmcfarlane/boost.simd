...
**/
//==================================================================================================
#ifndef BOOST_SIMD_TYPE_COMPLEX_FUNCTION_IMPL_IS_FINITE_HPP_INCLUDED
#define BOOST_SIMD_TYPE_COMPLEX_FUNCTION_IMPL_IS_FINITE_HPP_INCLUDED
...
namespace boost { namespace simd { namespace ext
{
                          ...
                          )
  {
    BOOST_FORCEINLINE auto  operator()(A0 const& a0) const
      ...
      (
        bs::logical_and(bs::is_finite(a0.real), bs::is_finite(a0.imag))
      )
  };
