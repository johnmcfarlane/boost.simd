...
namespace boost { namespace simd { namespace ext
{
  ...
  is_not_greater_ ( BOOST_SIMD_SUPPORTS(avx_)
                  , pack<double,4,avx_> const& a0
                  , pack<double,4,avx_> const& a1
                  ) BOOST_NOEXCEPT
  {
    return _mm256_cmp_pd(a0,a1, _CMP_NGT_OQ);
  }
  ...
  {
    return _mm256_cmp_ps(a0,a1, _CMP_NGT_OQ);
  }
  ...
  {
    return _mm_cmp_pd(a0,a1, _CMP_NGT_OQ);
  }
  ...
  {
    return _mm_cmp_ps(a0,a1, _CMP_NGT_OQ);
  }
