...
STF_CASE_TPL( "Addition with complex<T>/complex<T>", STF_IEEE_TYPES)
{
  ...
  STF_EQUAL(r0 + r0, bs::complex<T>(8,0));
  STF_EQUAL(r1 + r1, bs::complex<T>(0,4));
  STF_EQUAL(r2 + r2, bs::complex<T>(4,4));
  STF_EQUAL(r0 + r1, bs::complex<T>(4,2));
  STF_EQUAL(r0 + r2, bs::complex<T>(6,2));
  STF_EQUAL(r1 + r2, bs::complex<T>(2,4));
}

STF_CASE_TPL( "Addition with complex<T>/T", STF_IEEE_TYPES)
{
  bs::complex<T> r0(4,0), r1(0,2), r2(2,2);

  STF_EQUAL(r0 + 3 , bs::complex<T>(7,0));
  STF_EQUAL(3  + r0, bs::complex<T>(7,0));
  STF_EQUAL(r1 + 3 , bs::complex<T>(3,2));
  STF_EQUAL(3  + r1, bs::complex<T>(3,2));
  STF_EQUAL(r2 + 7 , bs::complex<T>(9,2));
  STF_EQUAL(7  + r2, bs::complex<T>(9,2));
}
