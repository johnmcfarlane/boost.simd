...
{
  template < typename T>
  BOOST_FORCEINLINE pack<std::int32_t,4,sse_> fma_(BOOST_SIMD_SUPPORTS(sse2_)
  ...
  template < typename T>
  BOOST_FORCEINLINE pack<std::int16_t,8,sse_> fma_(BOOST_SIMD_SUPPORTS(sse2_)
  ...
  template < typename T>
  BOOST_FORCEINLINE pack<std::uint32_t,4,sse_> fma_(BOOST_SIMD_SUPPORTS(sse2_)
  ...
  template < typename T>
  BOOST_FORCEINLINE pack<std::uint16_t,8,sse_> fma_(BOOST_SIMD_SUPPORTS(sse2_)
