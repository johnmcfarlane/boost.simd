...
**/
//==================================================================================================
#ifndef BOOST_SIMD_TYPE_COMPLEX_FUNCTION_IMPL_LOG_HPP_INCLUDED
#define BOOST_SIMD_TYPE_COMPLEX_FUNCTION_IMPL_LOG_HPP_INCLUDED
...
namespace boost { namespace simd { namespace ext
{
                          ...
                          )
  {
    ...
    {
      return { bs::log(abs(a0)), if_zero_else(is_positive(a0), Pi<A0>())};
    }
  };
