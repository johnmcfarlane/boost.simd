...
{
  BOOST_FORCEINLINE
  pack<std::int8_t,16,sse_> abs_( BOOST_SIMD_SUPPORTS(ssse3_)
  ...
  BOOST_FORCEINLINE
  pack<std::int16_t,8,sse_> abs_( BOOST_SIMD_SUPPORTS(ssse3_)
  ...
  BOOST_FORCEINLINE
  pack<std::int32_t,4,sse_> abs_( BOOST_SIMD_SUPPORTS(ssse3_)
