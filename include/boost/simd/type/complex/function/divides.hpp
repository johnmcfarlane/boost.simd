...
namespace boost { namespace simd { namespace cmplx
{
  ...
  /*!
    ...
    @defgroup complex-divides divides (function object, complex version)

    This function object, complex version implements the binary division operator for complex arithmetic
